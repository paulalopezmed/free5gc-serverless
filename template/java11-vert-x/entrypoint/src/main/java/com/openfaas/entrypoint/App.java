...
public class App {
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("custom logggggggggggggggggggggggggggggggggggggggggg");
    System.out.println(System.getenv("PORT"));
    Integer httpPort = Integer.parseInt(Optional.ofNullable(System.getenv("PORT")).orElse("31112"));
